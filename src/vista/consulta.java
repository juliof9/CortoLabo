...
public class consulta extends JFrame{
    ...
    public final void agregarLabels(){
        ...
        lblDisponibilidad = new JLabel("Disponibilidad en tienda");
    ...
    public final void formulario(){
        ...
        tipo.addItem("Leche");
        tipo.addItem("Jugo");
        tipo.addItem("Galletas");
        tipo.addItem("Gaseosa");
        ...
        precio.setBounds(140, 50, ANCHOC, ALTOC);
        ...
        buscar.setBounds(10, 10, ANCHOC, ALTOC);
        ...
        eliminar.addActionListener(new ActionListener(){
           ...
           public void actionPerformed(ActionEvent e){
               ...
               if (fd.delete(codigo.getText())){
                   ...
                   JOptionPane.showMessageDialog(null, "Ocurrio un problema al momento de eliminar producto");
               }
           }
        });
